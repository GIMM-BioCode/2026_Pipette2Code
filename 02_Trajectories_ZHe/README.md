...
!wget -O -q '2026_Pipette2Code/02_Trajectories_ZHe/data/DS1.h5ad' 'https://polybox.ethz.ch/index.php/s/GCZzdxkMiTp5ZQH'
!wget -O -q '2026_Pipette2Code/02_Trajectories_ZHe/data/DS1_raw.h5ad' 'https://polybox.ethz.ch/index.php/s/GeXSaepAk9fjQqk'
```
